...
def test_get_description(supvisors):
    """ Test the ViewContext.get_description method. """
    ...
    assert process.get_description() == ('10.0.0.1:25000', 'desc1 on 10.0.0.1')
    # test method return on running process
    process.running_identifiers.add('10.0.0.3:25000')
    assert process.get_description() == ('10.0.0.3:25000', 'desc3 on 10.0.0.3')
    # test method return on multiple running processes
    process.running_identifiers.add('10.0.0.2:25000')
    possible_results = [(['10.0.0.3:25000', '10.0.0.2:25000'], 'conflict on 10.0.0.3, 10.0.0.2'),
                        (['10.0.0.2:25000', '10.0.0.3:25000'], 'conflict on 10.0.0.2, 10.0.0.3')]
    assert process.get_description() in possible_results
    # test again with forced state
    event = {'state': ProcessStates.FATAL, 'identifier': '10.0.0.1:25000',
             'now_monotonic': 50, 'spawnerr': 'global crash'}
    assert process.force_state(event)
    assert process.get_description() == (None, 'global crash')
