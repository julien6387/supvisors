...
public class SystemXmlRpc {
    ...
    public List<String> listMethods() {
        ...
        return XmlRpcConversion.arrayToStringList(objectArray);
    }
    ...
    public static void main(String[] args) {
        ...
        if  (client != null) {
            ...
            List<String> result = XmlRpcConversion.arrayToStringList((Object[]) results[0]);
            ...
            result = XmlRpcConversion.arrayToStringList((Object[]) results[2]);
            System.out.println(result);
