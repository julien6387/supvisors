...
public class SupervisorConfigUpdates {
     ...
     */
     public SupervisorConfigUpdates(final Object[] objectsArray) {
        ...
        this.added = XmlRpcConversion.arrayToStringList((Object[]) array[0]);
        this.changed = XmlRpcConversion.arrayToStringList((Object[]) array[1]);
        this.removed = XmlRpcConversion.arrayToStringList((Object[]) array[2]);
    }
