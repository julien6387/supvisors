...
/**
 * The Class SupervisorsAddressInfo.
 *
 * It gives a structured form to the address information received from a XML-RPC.
 */
public class SupervisorsAddressInfo implements SupervisorsAnyInfo {
     ...
     * SILENT is used when the local Supervisors does not receive any heartbeat message from this address.
     * RUNNING is used when the local Supervisors receives heartbeat messages from this address.
     * ISOLATED is used when the local Supervisors has disconnected this address.
     */
    public enum State {
        UNKNOWN,
        SILENT,
     ...
     * in the reference time of the local Supervisors.
     *
     * @return Integer: The number of seconds since Epoch.
     */
   public Integer getLocalTime() {
    ...
    public String toString() {
        return "SupervisorsAddressInfo(name=" + this.name
