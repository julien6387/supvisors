...
public class SupervisorsXmlRpc {
    ...
    /**
     * The getSupervisorsState methods returns the status of Supervisors.
     *
     * @return SupervisorsStatus: The state of Supervisors.
     */
    public SupervisorsStatus getSupervisorsState() {
        HashMap result = client.rpcCall(Namespace + "get_supervisors_state", null, HashMap.class);
        return new SupervisorsStatus(result);
    }
    ...
    public HashMap<String, SupervisorsAddressInfo> getAllAddressesInfo() {
        ...
        return DataConversion.arrayToMap(objectsArray, SupervisorsAddressInfo.class);
    }
    ...
    public HashMap<String, SupervisorsApplicationInfo> getAllApplicationInfo() {
        ...
        return DataConversion.arrayToMap(objectsArray, SupervisorsApplicationInfo.class);
    }
    ...
    public HashMap<String, SupervisorsProcessInfo> getAllProcessInfo() {
        ...
        return DataConversion.arrayToMap(objectsArray, SupervisorsProcessInfo.class);
    }
    ...
    public HashMap<String, SupervisorsProcessRules> getProcessRules(final String namespec) {
        ...
        return DataConversion.arrayToMap(objectsArray, SupervisorsProcessRules.class);
    }
